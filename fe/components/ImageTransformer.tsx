...
//   const handleAPIUploadSuccess = (response: { success: boolean; asset?: { id: string; fileName: string; fileSize: number; fileType: string; url: string; } }) => {
...
//         {!uploadedFile ? (
//           <FileUpload
//             onUploadSuccess={handleUploadedFile}
