...
// Files API
router.post('/files/upload', uploadSingleFile, handleFileUploadError as express.ErrorRequestHandler, uploadFile as any);
router.get('/files', getFiles as any);
router.get('/files/:fileId', getFile as any);
router.delete('/files/:fileId', deleteFile as any);
router.post('/files/transform/:fileId', transformFileById as any);
